...
RUN yum -y install php php-opcache php-fpm php-mbstring php-xml php-mysql php-pdo php-gd php56w-pecl-imagick php-pecl-memcache php-intl php-pecl-xdebug php-mssql php-mcrypt
